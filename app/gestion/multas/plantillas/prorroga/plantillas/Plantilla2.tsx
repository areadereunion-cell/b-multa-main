    ...
    <div className="w-[420px] bg-[#f3f3f3] rounded-2xl overflow-hidden shadow-[0_18px_40px_rgba(0,0,0,0.18)] border border-[#ececec]">
      ...
      <div className="mx-4 mb-4 bg-[#f7f7f7] rounded-xl p-5 shadow-sm border border-[#efefef]">
        ...
        <div className="grid grid-cols-2 gap-4 items-end mb-8">
          ...
          <div className="flex justify-end">
            <div className="w-full border border-red-400 rounded-[22px] px-6 py-4 text-red-500 text-[24px] leading-none font-sans bg-[#fff7f7] text-center">
        ...
        <div>
          ...
          <div className="space-y-5">
            <div className="flex justify-between items-center gap-4">
              ...
              <span className="text-[18px] font-sans text-black">
                ${importePagar || "0"}
              </span>
            </div>
            ...
            <div className="flex justify-between items-center gap-4">
              ...
              <span className="text-[18px] font-sans text-black">$ 0</span>
            </div>
