...
"[project]/multas/multas/app/api/asesor/casos/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/multas/multas/node_modules/next/headers.js [app-route] (ecmascript)");
...
;
async function GET() {
    const c = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])();
    ...
    if (role !== "user" || !Number.isInteger(asesorId) || asesorId <= 0) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/asesor/multas/plantillas/complejas", process.env.NEXT_PUBLIC_BASE_URL || "http://localhost:3000"));
    }
    try {
        // detectar liga_pago
        const col = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT 1
    ...
    `);
      ...
      LIMIT 500
    `;
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(sql, [
            asesorId
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d310e78d._.js.map