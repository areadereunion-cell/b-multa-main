...
"[project]/multas/multas/app/api/plantillas-temporales-3/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    try {
        ...
        // ✅ texto directo
        const producto = safeString(body.subproducto ?? body.producto);
        const cuenta_bancaria = safeString(body.cuenta_bancaria);
        const metodo_pago = safeString(body.metodo_pago); // ✅ TEXTO
        if (!producto || !cuenta_bancaria || !metodo_pago) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "producto, cuenta_bancaria y metodo_pago son obligatorios"
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba9f28a3._.js.map