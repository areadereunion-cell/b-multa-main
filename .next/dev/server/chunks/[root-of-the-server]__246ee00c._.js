...
"[project]/Downloads/multa-main/multa-main/app/api/listas/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function DELETE(_req, context) {
    ...
    try {
        ...
        const existe = await client.query(`SELECT id FROM listas WHERE id = $1`, [
            listaId
        ]);
        ...
        await client.query(`DELETE FROM lista_items WHERE lista_id = $1`, [
            listaId
        ]);
      ...
      `, [
        ...
        // 3) Borrar la lista
        const deleted = await client.query(`DELETE FROM listas WHERE id = $1`, [
            listaId
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__246ee00c._.js.map