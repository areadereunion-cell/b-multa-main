...
"[project]/multas/multas/app/api/reportes/download/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (!date) return __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ok: false,
        error: "Falta date"
    }, {
        status: 400
    ...
    try {
        const r = await client.query(`SELECT file_name, file_path FROM public.reportes_diarios WHERE report_date = $1::date`, [
            date
        ]);
        if (r.rows.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: "No existe reporte para esa fecha"
            }, {
                status: 404
            });
        }
        const { file_name, file_path } = r.rows[0];
        ...
        const buf = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(file_path);
        return new __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](buf, {
            status: 200,
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__517f780e._.js.map