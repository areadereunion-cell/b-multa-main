...
"[project]/multas/multas/app/api/otp/verify/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const otpBodyRaw = String(body?.otp ?? "");
        const otpBody = otpBodyRaw.replace(/\D/g, "").slice(0, 6);
        if (!usernameBody || otpBody.length !== 6) {
        ...
        let payload;
        try {
            payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(preToken);
        } catch  {
            return __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const r = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT id, otp_hash
       FROM otp_tokens
       WHERE username = $1
         AND used_at IS NULL
         AND expires_at > NOW()
       ...
       LIMIT 1`, [
        ...
        if (!r.rows || r.rows.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "No hay OTP activo"
            }, {
                status: 400
            });
        }
        const row = r.rows[0];
        const incomingHash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashOtp"])(otpBody);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE otp_tokens SET used_at = NOW() WHERE id = $1`, [
            row.id
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__636bde84._.js.map