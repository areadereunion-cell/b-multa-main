...
async function POST(req) {
    try {
        ...
        // destino (tu config actual)
        const to = process.env.ALAN_EMAIL; // o FABRICIO_EMAIL, etc.
        if (!to) throw new Error("ALAN_EMAIL no configurado");
        // ✅ usar sendMail (NO mailer.sendMail)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ea584c5._.js.map