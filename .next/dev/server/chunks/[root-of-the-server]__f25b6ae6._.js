...
"[project]/Downloads/multa-main/multa-main/app/api/plantillas/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_, context) {
    try {
        ...
        // 🔥 VALIDACIÓN DE PAGO
        const yaPagado = row.pagado === true || row.pagado === "true" || row.pagado === "si";
        if (yaPagado) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$multa$2d$main$2f$multa$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: true,
                pagado: true
...
async function DELETE(_, context) {
    try {
        const { id } = await context.params;
        await pool.query("DELETE FROM plantillas_pago WHERE id = $1", [
            id
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$multa$2d$main$2f$multa$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f25b6ae6._.js.map