...
"[project]/multas/multas/lib/otp.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/multas/multas/lib/admin-rules.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/multas/multas/app/api/otp/send/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/multas/multas/lib/otp.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$admin$2d$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/multas/multas/lib/admin-rules.ts [app-route] (ecmascript)");
...
function isPreTokenPayload(v) {
    return v && typeof v === "object" && typeof v.username === "string" && typeof v.role === "string";
}
async function POST(req) {
    try {
        const body = await req.json().catch(()=>null);
        const usernameBody = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$admin$2d$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeUser"])(body?.username ?? "");
        const loginTimeISO = String(body?.loginTimeISO || "");
        if (!usernameBody) {
        ...
        let payload;
        try {
            const decoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(preToken);
        ...
        const usernameToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$admin$2d$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeUser"])(payload.username || "");
        ...
        const otp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateOtp6"])();
        const otpHash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashOtp"])(otp);
        const enc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["encryptOtp"])(otp);
        const ttl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["otpTtlMinutes"])();
        const now = new Date();
        const expiresAt = new Date(now.getTime() + ttl * 60 * 1000);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`INSERT INTO otp_tokens (username, otp_hash, otp_enc, otp_iv, otp_tag, expires_at)
       VALUES ($1, $2, $3, $4, $5, $6)`, [
            usernameBody,
            otpHash,
            enc.otp_enc,
        ...
        const activeRows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`SELECT username, otp_enc, otp_iv, otp_tag, created_at, expires_at
       FROM otp_tokens
       ...
       LIMIT 25`, []);
        const activeList = (activeRows.rows || []).map((r)=>{
            let otpPlain = "******";
            try {
                otpPlain = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decryptOtp"])({
                    otp_enc: r.otp_enc,
                    otp_iv: r.otp_iv,
                    otp_tag: r.otp_tag
                });
        ...
        const alanEmail = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$admin$2d$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAlanEmail"])();
        const fabricioEmail = (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$admin$2d$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFabricioEmail"])();
        const brandonEmail = process.env.BRANDON_EMAIL || "";
        const alanRecipients = [
            alanEmail,
            brandonEmail
        ].filter(Boolean);
        const textToAlan = `OTP ADMIN\n\n` + `Usuario: ${usernameBody}\n` + `Hora inicio sesión (front): ${loginTimeISO || "(no enviada)"}\n` + `Hora inicio sesión (server): ${now.toISOString()}\n` + `OTP: ${otp}\n` + `Expira: ${expiresAt.toISOString()}\n\n` + `OTP activos:\n` + activeList.map((x)=>`- ${x.username}: ${x.otp} (creado ${x.created_at}, expira ${x.expires_at})`).join("\n");
        // ✅ Caso Alan → Alan + Brandon
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$admin$2d$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isAlanUser"])(usernameBody)) {
        ...
        // ✅ Otros admins → Fabricio solo OTP
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$mailer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendMail"])({
            to: fabricioEmail,
            subject: "OTP de acceso",
            text: `Tu OTP es: ${otp}\nExpira: ${expiresAt.toISOString()}`
        });
        // ✅ Auditoría completa → Alan + Brandon
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$lib$2f$mailer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendMail"])({
            to: alanRecipients.join(","),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e99bde97._.js.map