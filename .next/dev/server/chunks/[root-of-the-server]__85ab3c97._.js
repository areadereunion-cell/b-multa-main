...
"[project]/app/api/otp/verify/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const usernameBody = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeUser"])(usernameRaw);
        ...
        let payload;
        try {
            payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(preToken);
        } catch  {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const usernameToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2d$rules$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeUser"])(String(payload.username || ""));
        ...
        const debugRows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      ...
      `, [
        ...
        const r = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`
      SELECT id, otp_hash
      FROM otp_tokens
      WHERE username = $1
        AND used_at IS NULL
      ...
      `, [
        ...
        const row = r.rows[0];
        const incomingHash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashOtp"])(otpBody);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`UPDATE otp_tokens SET used_at = NOW() WHERE id = $1`, [
            row.id
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__85ab3c97._.js.map