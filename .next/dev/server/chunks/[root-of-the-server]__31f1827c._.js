...
"[project]/Downloads/b-multa-main/multa-main/app/api/plantillas-temporales/[token]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, ctx) {
    try {
        ...
        if (!clean) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$b$2d$multa$2d$main$2f$multa$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    `;
        ...
        if (r.rows.length === 0) return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$b$2d$multa$2d$main$2f$multa$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "No existe"
        }, {
            status: 404
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31f1827c._.js.map