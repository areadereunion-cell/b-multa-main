...
async function getReportRows(reportDateYMD) {
    ...
    // Debe devolver SIEMPRE un array de objetos.
    // Ejemplo (mock):
    return [
        {
            Cliente: "Juan",
...
async function generateDailyReport({ reportDateYMD }) {
    ...
    // si no hay filas, igual crea una hoja vacía (opcionalmente con headers)
    const ws = rows.length > 0 ? __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["utils"].json_to_sheet(rows) : __TURBOPACK__imported__module__$5b$project$5d2f$multas$2f$multas$2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["utils"].aoa_to_sheet([
        [
    ...
    // ✅ escribir archivo físico en /tmp
    ...
    return {
        ...
        fileName,
        tmpPath,
        // ✅ esto es lo que debe usar tu front en href para descargar
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b37b2a0e._.js.map