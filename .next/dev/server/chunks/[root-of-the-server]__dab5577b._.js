...
"[project]/Downloads/b-multa-main/multa-main/app/api/sync-pago/[token]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/* 🔥 TOKEN UUID CORRECTO */ function generarToken() {
...
async function POST(req) {
    ...
    try {
        ...
        /* 🔥 FLEXIBLE (AQUÍ ESTÁ LA CORRECCIÓN) */ const producto = safeString(body.subproducto) || safeString(body.producto) || safeString(body.ubproducto);
        const cuenta_bancaria = safeString(body.cuenta_bancaria) || safeString(body.cuenta) || safeString(body.cuentaBancaria);
        if (!producto || !cuenta_bancaria) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$b$2d$multa$2d$main$2f$multa$2d$main$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ...
                debug: {
                    subproducto: body.subproducto,
                    producto: body.producto,
                    cuenta_bancaria: body.cuenta_bancaria
                }
            }, {
                status: 400
            });
        }
        /* ===== TOKEN ÚNICO ===== */ let token = null;
        let existe = true;
        while(existe){
            token = generarToken();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dab5577b._.js.map