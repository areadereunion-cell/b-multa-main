...
async function POST(req) {
    ...
    try {
        ...
        const producto = safeString(body.subproducto) || safeString(body.producto);
        const cuenta_bancaria = safeString(body.cuenta_bancaria) || safeString(body.cuenta);
        ...
        /* ===== TOKEN ÚNICO UUID ===== */ let token = null;
        let existe = true;
        while(existe){
            token = generarToken();
