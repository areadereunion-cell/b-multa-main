...
async function upsertReporte(dateISO, filePath) {
...
async function POST(req) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].mkdir(reportsDir, {
            recursive: true
        });
        const diskPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(reportsDir, fileName);
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(diskPath, excelBuffer);
...
async function generarExcelBuffer(date) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9b7f65c3._.js.map