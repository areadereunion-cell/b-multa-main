...
"[project]/Downloads/b-multa-main/multa-main/app/api/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$b$2d$multa$2d$main$2f$multa$2d$main$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])("SELECT username, password, role FROM users WHERE username = $1", [
            username
        ]);
        ...
        const preToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$b$2d$multa$2d$main$2f$multa$2d$main$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signToken"])({
            username: user.username,
            role: user.role,
            otpVerified: false
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__550dfbd0._.js.map